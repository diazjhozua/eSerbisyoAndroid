...
public class ComplaintAnalyticsFragment extends Fragment {
    private View view;
    ...
    public ComplaintAnalyticsFragment() {
    ...
    private void getData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Api.COMPLAINTS_ANALYTICS, response -> {

            try {
                JSONObject object = new JSONObject(response);
                JSONArray typesJsonArray = new JSONArray(object.getString("complaintTypes"));
                JSONArray trendingTypesJsonArray = new JSONArray(object.getString("trendingComplaints"));
                JSONObject userSubmittedJsonObject = new JSONObject(object.getString("userComplaint"));
                ...
                for (int i = 0; i < typesJsonArray.length(); i++) {
                    ...
                    if (typesJsonObject.getInt("complaints_count") > 0) {
                        pieEntries.add(new PieEntry((float) (typesJsonObject.getInt("complaints_count")),
                ...
                for (int i = 0; i < trendingTypesJsonArray.length(); i++) {
                    ...
                    Type mType = new Type(
                            typesJsonObject.getInt("id"), typesJsonObject.getString("name"), typesJsonObject.getInt("complaints_count") + " complaints"
                    );
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("MOST SUBMITTED COMPLAINTS (THIS YEAR)");
